...
function SpeedTypingGame() {
  const paragraphs=[
    "A plant is one of the most important living things that develop on the earth and is made up of stems, leaves, roots, and so on.Parts of Plants: The part of the plant that developed beneath the soil is referred to as root and the part that grows outside of the soil is known as shoot. The shoot consists of stems, branches, l aves, fruits, and flowers. Plants are made up of six main parts: roots, stems,  leaves, flowers, fruits, and seeds.",
    ...
    "An aunt is a bassoon from the right perspective. As far as we can estimate, some posit he melic myanmar to be less than kutcha. One cannot separate foods from blowzy bows The scampish closet reveals itself as a sclerous llama to those who look. A hip is the kirt of a peak. Some hempy laundries are thought of simply as orchids. A gum is a trumpet from the right perspective. A freebie flight is a wrench of the mind. Some."
  ]
